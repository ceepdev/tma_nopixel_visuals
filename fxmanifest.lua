...
files {
    ...
    'data/timecycle/w_foggy_sunny.xml',
    ...
    'data/weather/desert_emitter_ground.xml',
    'data/weather/desert_emitter_ground_heavy.xml',
    'data/weather/desert_render_ground.xml',
    'data/weather/desert_render_ground_heavy.xml',
...
data_file 'TIMECYCLE_FILE' 'data/timecycle/w_foggy_sunny.xml'
